...
public abstract class CommandModuleBase<TContext> : CommandModuleBase, ICommandModule<TContext>
...
public abstract class CommandModuleBase : ICommandModuleActions
{
    /// <summary>
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    public virtual Task OnBeforeExecutionAsync(CommandInfo commandInfo, CancellationToken cancellationToken) =>
        Task.CompletedTask;

    public virtual Task OnAfterExecutionAsync(CommandInfo commandInfo, CancellationToken cancellationToken) =>
        Task.CompletedTask;

    public virtual Task<bool> CheckPreConditionsAsync(CommandInfo commandInfo, CancellationToken cancellationToken) =>
